...
class newGame {
  ...
  startPage() {
    const start = new __WEBPACK_IMPORTED_MODULE_1__start_page_js__["a" /* default */](this.stage, this.world);
    start.createPage();
  }
  ...
  createStartBtn(){
    ...
    document.addEventListener('keydown', (e) => {
      if (e.key === 's') {
        ...
        let game = new __WEBPACK_IMPORTED_MODULE_0__game_js__["a" /* default */](this.stage, this.world);
        game.start();
      }
    });
  }
...
const calculateIntersection = (rect1, rect2, x, y) => {
...
/* unused harmony export calculateIntersection */
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__start_page_js__ = __webpack_require__(2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__new_game_js__ = __webpack_require__(1);
...
document.addEventListener('DOMContentLoaded', () => {
  let game = new __WEBPACK_IMPORTED_MODULE_3__new_game_js__["a" /* default */]();
  game.startPage();
});
